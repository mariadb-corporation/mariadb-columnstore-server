...
SET(CPACK_PACKAGE_FILE_NAME "${INFINIDB_DEBIAN_PACKAGE_NAME}-${CPACK_DEBIAN_PACKAGE_VERSION}-${INFINIDB_BIT}")
...
SET(CPACK_DEBIAN_CLIENT_PACKAGE_VERSION ${PACKAGE_VERSION}-${CPACK_DEBIAN_PACKAGE_RELEASE})
...
MACRO(ALTERNATIVE_NAME real alt)
  SET(ver "${CPACK_DEBIAN_PACKAGE_VERSION}")
  IF (${epoch})
    SET(ver "${epoch}:${ver}")
  ENDIF()
