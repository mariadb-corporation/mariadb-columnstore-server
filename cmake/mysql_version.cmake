...
MACRO(GET_MYSQL_VERSION)
  ...
  MYSQL_GET_CONFIG_VALUE("COLUMNSTORE_VERSION_MAJOR" COLUMNSTORE_MAJOR_VERSION)
  MYSQL_GET_CONFIG_VALUE("COLUMNSTORE_VERSION_MINOR" COLUMNSTORE_MINOR_VERSION)
  MYSQL_GET_CONFIG_VALUE("COLUMNSTORE_VERSION_PATCH" COLUMNSTORE_PATCH_VERSION)
  MYSQL_GET_CONFIG_VALUE("COLUMNSTORE_VERSION_EXTRA" COLUMNSTORE_EXTRA_VERSION)
  MYSQL_GET_CONFIG_VALUE("COLUMNSTORE_VERSION_RELEASE" COLUMNSTORE_RELEASE_VERSION)
...
IF(NOT "${MAJOR_VERSION}" MATCHES "[0-9]+" OR
  ...
  SET(COLUMNSTORE_VERSION "${COLUMNSTORE_MAJOR_VERSION}.${COLUMNSTORE_MINOR_VERSION}.${COLUMNSTORE_PATCH_VERSION}${COLUMNSTORE_EXTRA_VERSION}")
  SET(COLUMNSTORE_RELEASE "${COLUMNSTORE_RELEASE_VERSION}")
  MESSAGE(STATUS "MariaDB-Server ${VERSION}")
  MESSAGE(STATUS "MariaDB-Columnstore ${COLUMNSTORE_VERSION}")
  SET(MYSQL_BASE_VERSION "${MAJOR_VERSION}.${MINOR_VERSION}" CACHE INTERNAL "MySQL Base version")
  SET(MYSQL_NO_DASH_VERSION "${MAJOR_VERSION}.${MINOR_VERSION}.${PATCH_VERSION}")
  SET(COLUMNSTORE_NO_DASH_VERSION "${COLUMNSTORE_MAJOR_VERSION}.${COLUMNSTORE_MINOR_VERSION}.${COLUMNSTORE_PATCH_VERSION}")
  ...
  SET(PACKAGE_VERSION ${COLUMNSTORE_VERSION})
  SET(PACKAGE_RELEASE ${COLUMNSTORE_RELEASE})
ENDMACRO()
...
IF(NOT COMPILATION_COMMENT)
  SET(COMPILATION_COMMENT "Columnstore ${COLUMNSTORE_VERSION}-${COLUMNSTORE_RELEASE}")
ENDIF()
...
IF(NOT CPACK_SOURCE_PACKAGE_FILE_NAME)
  SET(CPACK_SOURCE_PACKAGE_FILE_NAME "mariadb-columnstore-${VERSION}")
ENDIF()
SET(CPACK_PACKAGE_CONTACT "MariaDB-Columnstore <support@mariadb.com>")
SET(CPACK_PACKAGE_VENDOR "MariaDB AB")
SET(CPACK_SOURCE_GENERATOR "TGZ")

# Defintions for windows version resources
SET(PRODUCTNAME "MariaDB-Columnstore Server")
